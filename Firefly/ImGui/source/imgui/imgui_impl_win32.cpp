...
std::function<LRESULT(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)> APA::myImGuiWin32MessageHandler;
...
{
    if (APA::myImGuiWin32MessageHandler)
    {
        APA::myImGuiWin32MessageHandler(hWnd, msg, wParam, lParam);
    }
